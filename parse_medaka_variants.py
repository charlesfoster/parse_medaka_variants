...
def main(sysargs=sys.argv[1:]):
    ...
    parser.add_argument(
        ...
        required=False,
        default="MN908947.3",
        help="CHROM in vcf (based on reference genome). Default: MN908947.3",
    )
    parser.add_argument(
        "-l",
        "--length",
        ...
        required=False,
        default="29903",
        help="Length of reference genome. Default: 29903",
    )
    parser.add_argument(
        "-o",
        "--outfile",
    ...
    ### STEP 1: read BAM and get counts, positions
    region = Region.from_string(f'{args.chrom}:0-{args.length}')
    bam_file = args.bam
